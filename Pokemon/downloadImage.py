...
#--------- Main Program ----------
t0 = time.time()  # start timer yass

version = (3, 0)
cur_version = sys.version_info
if cur_version >= version:  # If the Current Version of Python is 3.0 or above coz I'm kinda hung up on conda these days
...
# or download multiple images based on keywords
    ...
    while i < len(search_keyword):
        ...
        dir_name = "data/" + search_term + ('-' + args.color if args.color else '')
